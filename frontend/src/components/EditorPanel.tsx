      ...
      <div className={`flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b ${
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-1 md:gap-2">
            <span className="text-base md:text-lg">{selectedLanguage?.icon}</span>
            <span className={`text-sm font-medium hidden sm:inline ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
